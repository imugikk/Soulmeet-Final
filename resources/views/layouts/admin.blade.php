    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    @if(Request::is('/admin/statistic'))
                        <a href="{{url('/admin/statistic')}}" class="nav-link active">
                            @else
                                <a href="{{url('/admin/statistic')}}" class="nav-link">
                                    @endif
                ...
                <li class="nav-item has-treeview">
                    @if(Request::is('/admin/expert'))
                        <a href="{{url('/admin/expert')}}" class="nav-link">
                            @else
                                <a href="{{url('/admin/expert')}}" class="nav-link">
                                    @endif
