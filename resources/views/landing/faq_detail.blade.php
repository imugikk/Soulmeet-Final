    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mr-5">Faq</h5>
                <!--end::Title-->
            </div>
            <a href="/admin/faq" class="btn btn-primary float-right mr-2">
                Back
            </a>
            <!--end::Details-->
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form id="filter_content" action="/admin/faq-detail/store" method="POST">
                                @csrf
                                <input type="hidden" name="faq_id" class="form-control" value="{{ $id }}">
        ...
        <div class="modal-body">
            <form id="form-update" method="post">
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <label for="questions" class="form-label">Question</label>
                        <textarea type="text" id="questions" name="questions" class="form-control"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-12">
                        <label for="answers" class="form-label">Answer</label>
                        <textarea type="text" id="answers" name="answers" class="form-control"></textarea>
                    </div>
                </div>
...
<script>
    function edit(id){
        var url = '/admin/faq-detail/show/'+id;
        var link = '/admin/faq-detail/update/'+id;
        $.ajax({
            url : url,
            method: 'get',
            success: function(response) {
                $('#form-update').prop('action', link);
                $('#questions').val(response.data['questions']);
                $('#answers').val(response.data['answers']);
