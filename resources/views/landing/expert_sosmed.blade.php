    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mr-5">Expert Sosmed</h5>
                <!--end::Title-->
            </div>
            <a href="/admin/expert-detail/{{ $expert_detail->id_experts }}" class="btn btn-primary float-right mr-2">
                Back
            </a>
            <!--end::Details-->
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form id="filter_content" action="/admin/expert-detail/expert/store" method="POST" >
                                @csrf
                                <input type="hidden" name="id_expert_details" class="form-control" value="{{ $id }}">
...
<script>
    function edit(id){
        var url = '/admin/expert-detail/expert/show/'+id;
        var link = '/admin/expert-detail/expert/update/'+id;
        $.ajax({
            url : url,
            method: 'get',
