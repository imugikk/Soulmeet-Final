            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form id="filter_content" action="/admin/faq/store" method="POST">
                                @csrf
        ...
        <tbody>
            @foreach ($faqs as $item)
                <tr>
                    ...
                    <td>
                        <a href="/admin/faq/delete/{{ $item->id }}" class="btn btn-danger float-right mr-2">
...
<script>
    function edit(id){
        var url = '/admin/faq/show/'+id;
        var link = '/admin/faq/update/'+id;
        $.ajax({
            url : url,
            method: 'get',
