...
<div id="form-main">
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="/admin/pricing-detail/{{ $pricing_detail->pricing_id }}" class="btn btn-primary float-right mr-2">
                Back
            </a>
            <!--end::Details-->
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form id="filter_content" action="/admin/pricing-item/store" method="POST">
                                @csrf
                                <input type="hidden" name="pricing_detail_id" class="form-control" value="{{ $id }}">
        ...
        <tbody>
            @foreach ($pricing_items as $item)
                <tr>
                    ...
                    <td>
                        <a href="/admin/pricing-item/delete/{{ $item->id }}" class="btn btn-danger float-right mr-2">
...
<script>
    function edit(id){
        var url = '/admin/pricing-item/show/'+id;
        var link = '/admin/pricing-item/update/'+id;
        $.ajax({
            url : url,
            method: 'get',
