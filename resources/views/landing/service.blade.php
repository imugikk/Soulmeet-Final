            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                            <form id="filter_content" action="/admin/service/store" method="POST">
                                @csrf
        ...
        <tbody>
            @foreach ($services as $item)
                <tr>
                    ...
                    <td>
                        <a href="/admin/service/delete/{{ $item->id }}" class="btn btn-danger float-right mr-2">
                            <i class="fa fa-trash"></i>
                        </a>
                        <a href="/admin/service-detail/{{ $item->id }}" class="btn btn-primary float-right mr-2">
                            <i class="fa fa-eye"></i>
                        </a>
...
<script>
    function edit(id){
        var url = '/admin/service/show/'+id;
        var link = '/admin/service/update/'+id;
        $.ajax({
            url : url,
            method: 'get',
